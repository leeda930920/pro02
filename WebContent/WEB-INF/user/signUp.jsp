			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td>
							<div class="form-row">
								<input type="text" name="id" id="id" placeholder="영문소문자 및 숫자를 혼용하여 15글자 이내로 아이디 입력" class="form-control"
								pattern="^[a-z0-9]{8,16}" maxlength="15" style="width:80%;display:inline-block;" autofocus required />
